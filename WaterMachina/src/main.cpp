...
SSD1306Wire display(0x3c, D4, D5);   // ADDRESS, SDA, SCL  -  SDA and SCL usually populate automatically based on your board's pins_arduino.h e.g. https://github.com/esp8266/Arduino/blob/master/variants/nodemcu/pins_arduino.h
...
void setup() {
  ...
  display.println("schrodinger wifi");
  display.display();
  delay(1000);
  display.clear();
